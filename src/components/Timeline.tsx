    ...
    <div className="h-screen flex flex-col">
      ...
      <ScrollArea className="flex-1 pr-2">
        <div className="space-y-3 pb-4 px-[12px]">
            ...
            >
              <CardContent className="p-3">
                ...
                <div className="relative bg-gray-100 rounded-lg aspect-video mb-2 overflow-hidden">
                  <div
                    className={`w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex flex-col items-center justify-center ${
                      currentScene === index 
                        ? 'bg-gradient-to-br from-video-primary/10 to-video-primary/20' 
                        : ''
                    }`}
                  >
                    {scene.isRendering ? (
          ...
          {/* Add Scene Button */}
          <Card
            className="border-2 border-dashed border-gray-300 hover:border-video-primary cursor-pointer transition-all duration-200 hover:bg-video-primary/5 group"
            onClick={onAddScene}
          >
